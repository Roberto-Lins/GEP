...
QUESTOES = [
    ...
    obj("M05", "N4", 8, topico=T,
        ...
        tempo=5),
    obj("M05", "N3", 9, topico=T,
        conceitos=["REL-T2-M05-C005", "REL-T2-M05-C014"],
        ...
        erro="Ler Tianxia como império territorial ou tomar a liberdade de comércio como sinal de igualdade.",
        tempo=4),
]
