...
export const checklists: Record<string, ItemChecklist[]> = {
  ...
  "03-tabua-radler": [
    ...
    {
      "id": "c02",
      "texto": "Consigo reconstruir PAZ, AM, PAM e ZAM a partir da figura."
    },
    {
      "id": "c03",
      "texto": "Consigo explicar e executar a primeira entrada (δ,t1)→(a,b)."
    },
    {
      "id": "c04",
      "texto": "Consigo definir b, formar C e justificar soma ou diferença."
    },
    {
      "id": "c05",
      "texto": "Consigo explicar e executar a segunda entrada (a,C)→(ae,Aqd)."
    },
    {
      "id": "c06",
      "texto": "Consigo distinguir o a auxiliar da altura verdadeira e obter Az e Δa."
    },
    {
      "id": "c07",
      "texto": "Consigo conferir separadamente o trabalho DHN-0607 com dados do ANB 2026."
    }
  ],
